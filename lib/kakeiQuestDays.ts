...
export const KAKEI_QUEST_DAYS: KakeiQuestDay[] = [
  {
    ...
    dialogue: [
      ...
      { speaker: "zundamon", text: "数えたら7費目もあったのだ。家賃と光熱費が3つ、仕事で使ってるツール代が3つくらいで、合計67,655円だったのだ。" },
    ...
    example: {
      ...
      caveat:
        "家賃・上下水道代は別途確認して追加しました。携帯電話代・保険料はこのカード明細に載っていませんでした(別払いのため)。人によってカードにまとまる費目は違うので、通帳や他の支払い方法も合わせて確認するのがおすすめです。",
    },
  },
  {
    day: 2,
